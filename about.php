...
require_once __DIR__ . '/includes/components/heroes/about_hero.php';
require_once __DIR__ . '/includes/components/advantages/about_advantages.php';
require_once __DIR__ . '/includes/components/heroes/order_hero.php';
require_once __DIR__ . '/includes/comments/feedback_form.php';
